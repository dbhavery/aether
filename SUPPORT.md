...
Free Companion — Community Edition is an early-preview, single-maintainer project. This document explains where to ask what, and what level of support you can realistically expect during the preview.
...
- Decisions that affect doctrine (anything in `docs/ARCHITECTURE-V2.md` or `docs/PRODUCT-PLAN.md`) are recorded as an ADR under `docs/adr/` and referenced from the relevant issue.
...
3. Check `docs/adr/` — the architecture decision records track resolved and pending calls, so your question may already be answered there.
...
- `docs/ARCHITECTURE-V2.md` — how the seven layers fit together.
