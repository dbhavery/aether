...
- **Related:** `docs/adr/ADR-0006-hardware-tier-model.md` (the foundational tier model, which this ADR refines). The change is motivated by the §4 on-hardware validation data (2026-04-24).
